...
for i in range(num_args):
	...
	if y1>ymax: ymax=y1
	plt.text(70,(ymax-0.15*i*ymax),r"Mode={}, I$_M$={}".format(int(x1),math.trunc(y1*100)/100.0), color=each_color[i], fontsize='x-large')
	plt.text(70,(0.95*ymax)-(0.15*i*ymax),r"Mode={}, I$_M$={}".format(int(x2),math.trunc(y2*100)/100.0), color=each_color[i], fontsize='x-large')
	plt.text(70,(0.9*ymax)-(0.15*i*ymax),r"Mode={}, I$_M$={}".format(int(x3),math.trunc(y3*100)/100.0), color=each_color[i], fontsize='x-large')
	#plt.text(70,(0.85*ymax)-(0.15*i*ymax),r"Mode={}, I$_M$={}".format(int(x4),math.trunc(y4*100)/100.0), color=each_color[i], fontsize='x-large')
